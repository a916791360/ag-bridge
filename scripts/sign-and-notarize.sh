...
APP_DIR="$DIST_DIR/AG Bridge.app"
...
SUBMISSION_ZIP="$DIST_DIR/AG-Bridge-v${VERSION}-notarization.zip"
FINAL_ZIP="$DIST_DIR/AG-Bridge-v${VERSION}.zip"
FINAL_DMG="$DIST_DIR/AG-Bridge-v${VERSION}.dmg"
DMG_STAGING_DIR="$(/usr/bin/mktemp -d "${TMPDIR:-/tmp}/ag-bridge-notarized-dmg.XXXXXX")"
