...
ZIP_NAME="AG-Bridge-v${VERSION}-unsigned.zip"
DMG_NAME="AG-Bridge-v${VERSION}-unsigned.dmg"
APP_NAME="AG Bridge.app"
DMG_VOLUME_NAME="AG Bridge"
DMG_STAGING_DIR="$(/usr/bin/mktemp -d "${TMPDIR:-/tmp}/ag-bridge-dmg.XXXXXX")"
